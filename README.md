...
##   宣伝
### 講演会のご案内
2024年3月25日(月)にデータサイエンティスト協会主催の『ベイズ推論』webセミナーで本の内容(「6.1節　ABテスト効果検証」)の紹介をさせていただきます。産業技術総合研究所人工知能研究センター　本村先生にもご講演いただけることになっており、大変お得な講演会です。
無料で可能な会員登録のみで受講可能ですので、「ベイズ推論とはなにか」に関心をお持ちの方は是非、お申し込み下さい。
[申込先](https://techplay.jp/event/937052)
