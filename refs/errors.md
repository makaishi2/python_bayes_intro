...
|章  |ページ  |内容　　　　　　　|補足|最終更新日|
|:--|---|:--|:--|:--|
|1章|p.17|6行目<br>(誤)  samples['prior']<br>(正)  prior_samples['prior']||2024-02-19|
|2章|p.25|最終行<br>(誤)x_samplesを用いて<br>(正)x_samples1を用いて||2024-02-19|
|4章|p.83|コード4.13 1行目<br>(誤)model_to_graphviz(model) <br>(正)model_to_graphviz(model2)||2024-02-19|
|4章|p.96|7行目<br>(誤)describe関数の出力から読み取った話と<br>(正)describe関数の出力から読み取った結果と||2024-02-19|
|5章|p.100|1行目<br>(誤)4章でも説明したとおり<br>(正)1.5.1項でも説明したとおり(prior_samplesをidata1と読み替えます)||2024-02-19|
|5章|p.101|3行目 <br>(誤)mu_meanとsigma_mean<br>(正)mu_mean1とsigma_mean1||2024-02-19|
|5章|p.155|1行目 <br>(誤)コード5.4.15の4行目<br>(正)コード5.4.15の5行目||2024-02-19|
|6章|p.210|コード6.3.13 1行目 <br>(誤)df_sum['偏差値'], df_sum['能力値']<br>(正)df_sum1['偏差値'], df_sum1['能力値']||2024-02-19|
